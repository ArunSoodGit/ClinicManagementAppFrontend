...
export class ReservationComponent implements OnInit {
  ...
  constructor(private router: Router, private route: ActivatedRoute,
              ...
              private prescriptionService: PrescriptionService, public datePipe: DatePipe,
  ...
  getFiles(): void {
    this.prescriptionService.getPrescriptionsForReservation(this.reservation).subscribe(prescription => {
  ...
  showPatient(): void {
    this.router.navigate(['/customers', this.reservation.patient.id]);
